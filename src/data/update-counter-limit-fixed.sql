...
-- 2. Ta bort befintliga funktioner först
DROP FUNCTION IF EXISTS get_counter(UUID, TEXT);
DROP FUNCTION IF EXISTS setup_standard_counters();

-- 3. Uppdatera get_counter funktionen med ny standardgräns
...
-- 4. Uppdatera setup_standard_counters funktionen med ny standardgräns
